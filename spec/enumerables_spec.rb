...
describe Enumerable do
  ...
  describe "#my_each_with_index" do
    it "puts every item with the index" do
      ...
      expect(array.my_each_with_index { |item, index| puts "#{index + 1}. #{item}" }).to eql(%w[jordy addis hanna])
    end
  end
  ...
  describe "#my_any?" do
    ...
    it "returns false if none of the items are Numerics" do
      array = ["t", "$", "a", "a", "j"]
      expect(array.my_any?(Numeric)).to eql(false)
    end
    it "returns true if any of the items contain the letter 'd'" do
      array = %w[jordy addis hanna]
      expect(array.my_any?(/d/)).to eql(true)
    end
    it "returns false if none of the items contain the letter 'c'" do
      array = %w[jordy addis hanna]
      expect(array.my_any?(/c/)).to eql(false)
    end
  end
  ...
  describe "#my_none?" do
    ...
    it "returns true if none of the items are Numerics" do
      array = ["1", "2", "3", "a", "j"]
      expect(array.my_none?(Numeric)).to eql(true)
    end
    ...
    it "returns true if none of the items contain the letter 'c'" do
      array = %w[jordy addis hanna]
      expect(array.my_none?(/c/)).to eql(true)
    end
  end
